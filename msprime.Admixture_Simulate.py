...
parser.add_option("-t", "--time_N1_N2_split", action = "store", type = "float", dest = "t_n1_n2", default=350, help="Set N1 N2 split time in kya; default=350")
parser.add_option("--time_N1_sample", action = "store", type = "float", dest = "t_n1_sample", default=50, help="Set N1 sample time in kya; default=50")
parser.add_option("--time_N2_sample", action = "store", type = "float", dest = "t_n2_sample", default=50, help="Set N2 sample time in kya; default=50")
