...
if (options.outdir == "Tenn"):
	...
	simulation = msprime_demo_models.Tenn_demography(S_N1, S_N2, options.AF_sample_size, options.EU_sample_size, options.AS_sample_size, options.pulses, options.seed, options.n1_admix_prop, options.n2_admix_prop, options.outdir, options.t_n1_n2, options.haplo, options.length)

elif (options.outdir == "Sriram"):
	simulation = msprime_demo_models.Sriram_demography(S_N1, S_N2, options.AF_sample_size, options.EU_sample_size, options.AS_sample_size, options.pulses, options.seed, options.n1_admix_prop, options.n2_admix_prop, options.outdir, options.t_n1_n2, options.haplo, options.length)

elif (options.outdir == "SplitPop"):
	simulation = msprime_demo_models.SplitPop_demography(S_N1, S_N2, options.AF_sample_size, options.EU_sample_size, options.AS_sample_size, options.pulses, options.seed, options.n1_admix_prop, options.n2_admix_prop, options.outdir, options.t_n1_n2, options.haplo, options.length)
