...
#		    random_seed = seed
#		    )
#    geno_outfile = open(outdir+'.eigenstratgeno.n1_'+str(n1_admix_prop)+'_n2_'+str(n2_admix_prop)+'_'+str(seed), 'w')  ##  Sriram.eigenstratgeno.n1_0.01_n2_0.05_200
...
#
#    rs_num = 0
#	#    for t, tree_sequence in enumerate(replicates):
#
#
